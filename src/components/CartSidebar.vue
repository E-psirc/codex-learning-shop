...
.cart-count{font-size:0.8rem;color:var(--color-text-dim);font-weight:500}
.cart-items{max-height:420px;overflow-y:auto;padding:8px 0}
...
@media(max-width:1024px){.cart-section{width:300px}}
